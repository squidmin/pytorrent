...
class TestGetMessage(unittest.TestCase):
    ...
    def test_keep_alive__to_bytes(self):
        msg_b = message.Message.get_message('keep-alive').to_bytes()
    ...
    def test_not_interested(self):
        ...
        self.assertEqual(isinstance(msg, message.NotInterested), True)
    ...
    def test_have__to_bytes(self):
        msg_b = message.Message.get_message('have', 0).to_bytes()
    ...
    def test_bitfield__to_bytes(self):
        ...
        self.assertEqual(msg.to_bytes(), bitfield_b)
    ...
    def test_request(self):
        msg = message.Message.get_message('request', 0, 1, 2 ** 8)
        self.assertEqual(msg, message.Request(0, 1, 2 ** 8))
